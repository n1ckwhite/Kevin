...
export const Times: FC = () => (
  <div className={s.container}>
    <TimesTitle strong="экономит ваше время" text="Наше решение " />
    <Subtitle text="*Возможна необходимость в корректировках полученного результата" />
    <ul className={s.tasks}>
      <Task books={BOOK.tasks} color="default" size="small" title="Задачи" />
      <Task books={BOOK.hours} color="gray" title="без Kevin" />
      <Task books={BOOK.minutes} color="green" title="c Kevin" />
    </ul>
